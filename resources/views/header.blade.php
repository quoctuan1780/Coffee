		...
		<div class="header-top">
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					...
					@if(Auth::check())
						<li><a href="#"><i class="fa fa-user" style="font-size: 12pt"> {{Auth::user()->full_name}}</i></a></li>
						...
						<div class="cart">
							...
							@foreach($product_cart as $product)
								...
								<a class="cart-item-delete" href="{{route('xoa-gio-hang', $product['item']['id'])}}"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="{{ route('chi-tiet-san-pham', $product['item']['id']) }}"><img src="image/product/{{$product['item']['image']}}" alt=""></a>
